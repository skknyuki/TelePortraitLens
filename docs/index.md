...
Tele Portrait Lens は、VRChat用の**アバターギミックのカメラ**です。  
**ポートレート撮影をしやすくする事** を主目的として制作されています。
...
たとえば **背景だけ画角を変える**、  
**前景に水面を写して Screen 合成し、写真に水面表現を加える** といった演出も可能です。
<br>
---

Tele Portrait Lens はとても特殊なカメラギミックになっております。  
ワールドによっては写りが上手くいかない事もあります。  
なので必ず下記サンプルアバターを試してみてから、ご検討ください。  
Boothの仕様上、返品や返金等は出来ませんのでご了承ください。
